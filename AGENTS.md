...
Issue、Pull Request、README、コメント、作業報告、ユーザー向け文言などの文章では、技術用語・サービス名・仕組みの名称を原則として略称だけで記載せず、正式名称で記載する。

コード上で外部仕様として定義されたフィールド名・識別子、クラス名、関数名、ライブラリやAPIが要求する名称等はこの限りではない。
